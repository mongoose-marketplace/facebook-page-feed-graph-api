				...
				<div class="meta-box-sortables">
					<div class="postbox mongoose-facebook-page-plugin__box">
						<div class="main inside">
							...
							<p><?php esc_html_e( 'Development relies on donations from kind-hearted supporters of the Facebook Page Plugin. If you\'re enjoying the plugin, please donate today.' ); ?></p>
							<p><a href="<?php echo esc_url( CJW_FBPP_PLUGIN_DONATE_LINK ); ?>" class="button"><?php esc_html_e( 'Donate Now', 'facebook-page-feed-graph-api' ); ?></a></p>
						</div>
					</div>
					<div class="postbox mongoose-facebook-page-plugin__box">
						<div class="main inside">
							<h3><i class="dashicons dashicons-email-alt"></i> <?php esc_html_e( 'Plugin Newsletter', 'facebook-page-feed-graph-api' ); ?></h3>
							<p><?php esc_html_e( 'Subscribe today to receive the latest updates for the Facebook Page Plugin', 'facebook-page-feed-graph-api' ); ?></p>
					...
					<div class="postbox mongoose-facebook-page-plugin__box">
						<div class="main inside">
							...
							<p><?php esc_html_e( 'Want to have your say about the Facebook Page Plugin?', 'facebook-page-feed-graph-api' ); ?></p>
